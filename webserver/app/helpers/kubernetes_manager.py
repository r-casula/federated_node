...
class KubernetesBase:
    ...
    async def initialize(
        self, base_class: client.CustomObjectsApi | client.BatchV1Api | client.CoreV1Api
    ) -> None:
...
async def get_k8s_base(
    base_class: client.CustomObjectsApi | client.BatchV1Api | client.CoreV1Api,
) -> KubernetesBase:
