...
class TestPagination:
    ...
    async def test_pagination(
        ...
        resp = await client.get('/datasets', params={"page": "2", "per_page": '2'}, headers=simple_admin_header)
    ...
    async def test_pagination_page_does_not_exist(
        ...
        """
        resp = await client.get('/datasets', params={"page": "5", "per_page": '2'}, headers=simple_admin_header)
    ...
    async def test_pagination_invalid_value_page(
        ...
        """
        resp = await client.get('/datasets', params={"page": "asdf", "per_page": '2'}, headers=simple_admin_header)
